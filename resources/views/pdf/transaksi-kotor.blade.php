...
<body class="pr-80 pl-80 ">
    <main>
        ...
        <div class="text-center">
            <p class="bold-text">Laporan Laba Kotor </p>
        ...
        <div class="pr-10 pl-10">
            <table class="w-full border-table">
                <tr class="border-table">
                    ...
                    <th class="border-table font-table">Total Pembelian</th>
                </tr>
                ...
                <tr class="border-table">
                    ...
                    <td class="border-table font-table">{{$value->jumlah_barang*$value->barang->harga_jual}}</td>
                </tr>
                @endforeach
            </table>
        </div>
